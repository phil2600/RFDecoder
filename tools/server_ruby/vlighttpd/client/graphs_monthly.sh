...
rrdtool graph ../THGR810-55_hyg_monthly.png -a PNG --title="Humidity" \
...
rrdtool graph ../all_temp_monthly.png -a PNG --title="Temperatures" \
--height=200 --width=750 --base=1000  \
--alt-autoscale \
--interlaced \
--color 'CANVAS#000000'				  \
...
rrdtool graph ../THN132N-AC_temp_monthly.png -a PNG --title="Temperature" \
...
rrdtool graph ../THN132N-5E_temp_monthly.png -a PNG --title="Temperature" \
--height=200 --width=750 \
--color 'CANVAS#000000'				  \
--color 'BACK#101010'				  \
--color 'FONT#C0C0C0'				  \
...
rrdtool graph ../THGR810-55_temp_monthly.png -a PNG --title="Temperature" \
--height=200 --width=750 \
--color 'CANVAS#000000'				  \
--color 'BACK#101010'				  \
--color 'FONT#C0C0C0'				  \
