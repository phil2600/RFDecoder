...
rrdtool graph ../THGR810-55_hyg_weekly.png -a PNG --title="Humidity" \
...
rrdtool graph ../all_temp_weekly.png -a PNG --title="Temperatures" \
--height=200 --width=750 --base=1000  \
--alt-autoscale \
--interlaced \
--color 'CANVAS#000000'				  \
...
rrdtool graph ../THN132N-AC_temp_weekly.png -a PNG --title="Temperature" \
...
--color 'SHADEA#404040'				  \
--color 'SHADEB#404040'				  \
--start end-7d --vertical-label "Deg C" \
'DEF:probe1=tempDB.rrd:THN132N-AC:AVERAGE' \
...
rrdtool graph ../THN132N-5E_temp_weekly.png -a PNG --title="Temperature" \
--height=200 --width=750 \
--color 'CANVAS#000000'				  \
--color 'BACK#101010'				  \
--color 'FONT#C0C0C0'				  \
...
rrdtool graph ../THGR810-55_temp_weekly.png -a PNG --title="Temperature" \
--height=200 --width=750 \
--color 'CANVAS#000000'				  \
--color 'BACK#101010'				  \
--color 'FONT#C0C0C0'				  \
